...
const faq: readonly BypassFaq[] = [
  ...
  {
    question: 'Is the ShyCloud bypass free?',
    answer:
      'Yes. Skip Wait is free. The ShyCloud path runs on supported pages with no paid plan.',
  },
];
