...
const intro =
  'Looking for a RomsFun bypass usually means a ROM page locked the download behind a countdown. Skip Wait is the free Chrome extension that runs a romsfun timer bypass and skip countdown path so the download control unlocks without babysitting the clock.';
...
const faq: readonly BypassFaq[] = [
  ...
  {
    question: 'Is the RomsFun bypass free?',
    answer:
      'Yes. Skip Wait is free. The RomsFun path runs on supported pages with no paid plan.',
  },
];
