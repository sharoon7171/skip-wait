...
const intro =
  'AnkerGames free downloads open a treasure-box waiting page with an initializing countdown before the real download controls appear. Skip Wait is the $1.50/month Chrome extension that clears that Opening Treasure Box delay so you are not stuck watching progress fill while the quick check finishes.';
...
const faq: readonly BypassFaq[] = [
  ...
  },
  {
    ...
    answer:
      'Skip Wait is $1.50 per month. Activate a license in the popup. The AnkerGames bypass runs on supported pages.',
  },
];
