...
const intro =
  'A LinkShortify bypass search usually starts after an Indian short-link share dumps you into encrypted gates and article unlock waits instead of the file. Skip Wait is the free Chrome extension that walks that network—gate pages, blog continues, countdown unlock—so you are not babysitting every hop by hand.';
...
const faq: readonly BypassFaq[] = [
  ...
  },
  {
    ...
    answer:
      'Yes. Skip Wait is free. The LinkShortify path runs on supported pages with no paid plan.',
  },
];
