...
const intro =
  'Tech8s and Ez4Short shares open a safe redirect, dump you on a PLEASE WAIT blog, then a step 3/3 screen that wants you to watch ads before Continue appears. Skip Wait is the $1/month Chrome extension that walks that ad-link chain so a skip short link path does not mean tapping every gate yourself.';
...
const faq: readonly BypassFaq[] = [
  ...
  },
  {
    ...
    answer:
      'Skip Wait is $1 per month. Activate a license in the popup. The Tech8s / Ez4Short path runs on supported pages.',
  },
];
