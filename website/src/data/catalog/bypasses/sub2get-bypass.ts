...
const intro =
  'A Sub2Get bypass search usually means a monetized short URL parked you on a subscribe-to-unlock waiting page instead of the file. Skip Wait is the free Chrome extension that clears that please wait bypass and skip click to continue loop so the destination opens without finishing every social prompt by hand.';
...
const faq: readonly BypassFaq[] = [
  ...
  {
    question: 'Is the Sub2Get bypass free?',
    answer:
      'Yes. Skip Wait is free. The Sub2Get path runs on supported pages with no paid plan.',
  },
];
