...
const intro = "CPMLink bypass skips hop pages and unlock countdown waits on this ad link monetization platform to reach your destination URL faster and easier. Install Skip Wait once and it runs automatically on supported pages.";

const problem = "CPMLink monetized short links chain gate pages, captcha screens, and unlock timers before the destination.";
...
const steps: readonly BypassStep[] = [
  {
    ...
    body: "Install Skip Wait from the Chrome Web Store. The CPMLink bypass turns on automatically on supported pages—no account needed.",
  },
  {
    title: "Keep the extension enabled",
    body: "Leave Skip Wait on in Chrome. There is nothing to configure for CPMLink.",
  },
  {
    title: "Open a supported link",
    body: "Open a CPMLink link the same way you usually do. No paste tool or special settings.",
  },
  {
    title: "Reach the destination faster",
    body: "Skip Wait runs in the background on the matching page and moves you past the supported CPMLink delay.",
  },
];
