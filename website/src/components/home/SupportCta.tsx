...
export function SupportCta(): React.ReactElement {
  return (
    <section className="bg-surface-canvas py-16 lg:py-20">
      <Shell>
        <div className="relative overflow-hidden rounded-panel bg-primary-600 px-6 py-10 text-center shadow-xl shadow-primary-950/10 sm:px-10 lg:py-12">
          <div
            aria-hidden
          ...
          <div className="relative mx-auto max-w-2xl">
            <h2 className="font-display text-title-lg text-white">
              Need a Countdown or Link Shortener Bypass?
            </h2>
            <p className="mt-2 text-body-sm text-primary-100">
              Share the page URL and how the wait or unlock flow works. We’ll add support when a
              bypass is possible.
            </p>
