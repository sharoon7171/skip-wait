...
export function TelegramIcon({ className = '' }: TelegramIconProps): React.ReactElement {
  const uid = useId().replace(/:/g, '');
  const blue = `telegram-blue-${uid}`;
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={blue} x1="120" y1="240" x2="120" y2="0" gradientUnits="userSpaceOnUse">
