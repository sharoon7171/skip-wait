export function HeroBackdrop(): React.ReactElement {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute inset-0 bg-[linear-gradient(180deg,oklch(0.985_0_0)_0%,oklch(1_0_0)_100%)]" />

      <div
        className="absolute inset-0 [mask-image:radial-gradient(115%_85%_at_50%_-8%,black_38%,transparent_80%)]"
        style={{
          backgroundImage: 'radial-gradient(oklch(0.48 0.22 255 / 0.12) 1px, transparent 1.5px)',
