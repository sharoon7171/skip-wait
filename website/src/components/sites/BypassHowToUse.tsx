...
export function BypassHowToUse(): React.ReactElement {
  return (
    <section
      id="how-to-use"
      className="scroll-mt-24 border-b border-neutral-200 pb-12 pt-8 sm:pt-9 lg:border-b-0 lg:pb-0"
    >
      ...
      <p className="mt-4 max-w-prose text-body-sm leading-relaxed text-ink-body">
        Same steps for every bypass. Install once, then open links the way you already do.
      </p>

      <ol className="m-0 mt-8 list-none space-y-7 p-0">
        {bypassHowToSteps.map((step, index) => (
          ...
          >
            <span
              aria-hidden
              className="font-display text-[2rem] font-extrabold leading-none tracking-tight text-neutral-300 tabular-nums sm:text-[2.5rem]"
            >
