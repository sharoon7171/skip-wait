...
export default function NotFound(): React.ReactElement {
  return (
    <section className="relative bg-surface-canvas">
      <HeroBackdrop />
      <Shell className="relative flex flex-col items-center py-20 text-center sm:py-24 lg:py-28">
        ...
        <p className="mt-3 max-w-md text-body-sm text-ink-body">
          That page isn’t on this site. Go home or browse supported countdown and URL shortener
          pages.
        </p>
